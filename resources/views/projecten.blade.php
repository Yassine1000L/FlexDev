    ...
    <section class="min-h-screen flex flex-col justify-center px-6 pt-24">
        <div class="max-w-6xl mx-auto w-full">
            ...
            <div class="grid md:grid-cols-2 gap-6">
                <div class="rounded-2xl overflow-hidden border border-white/10 shadow-[0_0_30px_rgba(59,130,246,0.06)] hover:border-blue-400/30 hover:scale-[1.02] hover:shadow-[0_0_50px_rgba(59,130,246,0.15)] transition-all duration-300 cursor-pointer">
