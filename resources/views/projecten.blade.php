    ...
    <section class="min-h-screen flex flex-col justify-center px-6 pt-24">
        <div class="max-w-6xl mx-auto w-full">
            ...
            <div class="grid md:grid-cols-2 gap-6">
                <div class="rounded-2xl overflow-hidden border border-white/10 shadow-[0_0_30px_rgba(255,255,255,0.04)] hover:border-white/30 hover:scale-[1.02] hover:shadow-[0_0_50px_rgba(255,255,255,0.1)] transition-all duration-300 cursor-pointer">
