...
@section('content')
    ...
    <section class="min-h-screen flex flex-col justify-center px-6 pt-28 relative overflow-hidden">
        ...
        <div class="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] md:w-[800px] md:h-[800px] rounded-full bg-green-500/10 blur-[120px] pointer-events-none"></div>
    ...
    <section id="over" class="py-28 px-6 animate">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="mt-12 grid grid-cols-2 md:grid-cols-4 gap-4 max-w-3xl mx-auto">
                ...
                <div class="rounded-xl border border-green-500/10 bg-green-500/5 p-5 text-center hover:-translate-y-1 hover:shadow-[0_0_30px_rgba(34,197,94,0.12)] transition-all duration-300">
                    <svg class="w-6 h-6 mx-auto mb-2 text-green-400/60" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                    <span class="text-2xl font-bold text-green-400">2</span>
                    <p class="text-xs text-slate-400 mt-1">{{ __('Jaar ervaring') }}</p>
                </div>
                <div class="rounded-xl border border-green-500/10 bg-green-500/5 p-5 text-center hover:-translate-y-1 hover:shadow-[0_0_30px_rgba(34,197,94,0.12)] transition-all duration-300">
                    <svg class="w-6 h-6 mx-auto mb-2 text-green-400/60" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M14 10h4.764a2 2 0 011.789 2.894l-3.5 7A2 2 0 0115.263 21h-4.017c-.163 0-.326-.02-.485-.06L7 20m7-10V5a2 2 0 00-2-2h-.095c-.5 0-.905.405-.905.905 0 .714-.211 1.412-.608 2.006L7 11v9m7-10h-2M7 20H5a2 2 0 01-2-2v-6a2 2 0 012-2h2.5"/></svg>
                    <span class="text-2xl font-bold text-green-400">100%</span>
                    <p class="text-xs text-slate-400 mt-1">{{ __('Tevreden klanten') }}</p>
                </div>
                <div class="rounded-xl border border-green-500/10 bg-green-500/5 p-5 text-center hover:-translate-y-1 hover:shadow-[0_0_30px_rgba(34,197,94,0.12)] transition-all duration-300">
                    <svg class="w-6 h-6 mx-auto mb-2 text-green-400/60" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
                    <span class="text-2xl font-bold text-green-400">{{ __('24u') }}</span>
    ...
    <section id="diensten" class="py-28 px-6 animate">
        <div class="max-w-6xl mx-auto">
            ...
            <div class="max-w-5xl mx-auto">
                ...
                <div class="rounded-xl overflow-hidden border border-white/10 hover:-translate-y-1 hover:shadow-[0_0_40px_rgba(34,197,94,0.15)] transition-all duration-300">
                    ...
                    <div class="p-5">
                        <span class="text-xs font-bold text-green-400/60">{{ $svc['nr'] }}</span>
    ...
    <section id="waarom" class="py-28 px-6 animate">
        <div class="max-w-5xl mx-auto">
            ...
            <div class="grid md:grid-cols-3 gap-6">
                <div class="rounded-2xl border border-white/10 bg-gradient-to-br from-green-500/5 to-transparent p-6 text-center hover:border-green-400/30 hover:shadow-[0_0_30px_rgba(34,197,94,0.1)] transition-all">
                ...
                <div class="rounded-2xl border border-white/10 bg-gradient-to-br from-green-600/10 to-transparent p-6 text-center hover:border-green-400/30 hover:shadow-[0_0_30px_rgba(34,197,94,0.1)] transition-all">
                    <span class="text-3xl block mb-3">💎</span>
    ...
    <section id="contact" class="py-28 px-6 animate">
        <div class="max-w-3xl mx-auto">
            ...
            <form action="{{ route('contact.store') }}" method="POST" class="max-w-lg mx-auto">
                ...
                <div class="mb-4">
                    <input type="text" name="name" placeholder="{{ __('Uw naam') }}" required class="w-full bg-transparent border-b border-white/20 py-3 text-sm outline-none focus:border-green-400/60 transition-colors placeholder:opacity-30">
                </div>
                <div class="mb-4">
                    <input type="email" name="email" placeholder="{{ __('Uw e-mailadres') }}" required class="w-full bg-transparent border-b border-white/20 py-3 text-sm outline-none focus:border-green-400/60 transition-colors placeholder:opacity-30">
                </div>
                <div class="mb-4">
                    <input type="tel" name="phone" placeholder="{{ __('Telefoonnummer (optioneel)') }}" class="w-full bg-transparent border-b border-white/20 py-3 text-sm outline-none focus:border-green-400/60 transition-colors placeholder:opacity-30">
                </div>
                <div class="mb-6">
                    <textarea name="message" rows="4" placeholder="{{ __('Extra toelichting (optioneel)') }}" class="w-full bg-transparent border-b border-white/20 py-3 text-sm outline-none focus:border-green-400/60 transition-colors placeholder:opacity-30 resize-none"></textarea>
                </div>
                <button type="submit" class="w-full px-8 py-3 bg-green-600 text-white text-sm font-medium rounded-full hover:bg-green-500 transition-all shadow-lg shadow-green-500/20">{{ __('Verstuur Bericht') }}</button>
            </form>
        </div>
    </section>
