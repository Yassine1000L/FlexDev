...
@section('content')
    <section class="min-h-screen flex flex-col justify-center px-6 pt-28 relative overflow-hidden">
        ...
        <div class="max-w-6xl mx-auto w-full relative z-10">
            <p class="text-sm opacity-40 mb-6 tracking-widest uppercase">Developer & Probleemoplosser</p>
            <h1 class="text-4xl sm:text-7xl md:text-9xl font-bold tracking-tight leading-none">
                Ik Bouw<br>
                <span class="opacity-60">Ik Fix</span>
            </h1>
            <p class="mt-8 text-lg md:text-xl opacity-50 max-w-xl leading-relaxed">
            ...
            <div class="mt-20 max-w-3xl">
                ...
                <div class="flex flex-wrap gap-x-6 gap-y-3">
                    <div class="flex items-center gap-2 opacity-50 hover:opacity-80 hover:-translate-y-0.5 transition-all duration-300 whitespace-nowrap">
            ...
            <div class="mt-12 flex flex-col sm:flex-row gap-4">
                <a href="{{ route('contact') }}" class="inline-flex items-center px-8 py-3 bg-white text-black text-sm font-medium rounded-full hover:bg-white/90 transition-all">Neem contact op</a>
                <a href="{{ route('projecten') }}" class="inline-flex items-center px-8 py-3 border border-white/20 text-sm font-medium rounded-full hover:border-white/50 transition-all">Bekijk mijn werk</a>
            </div>
        </div>
    </section>
@endsection
